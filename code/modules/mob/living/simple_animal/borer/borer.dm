...
//	AddAbility(new/obj/effect/proc_holder/alien/hide(null)) metka
...
/mob/living/simple_animal/borer/proc/detatch()
	...
	if(istype(host,/mob/living/carbon/human))    // metka
...
/mob/living/simple_animal/borer/Crossed(AM as mob|obj)
	if(ishuman(AM))
		if(!stat)
			var/mob/M = AM
			M << "<span class='notice'>\icon[src] Bruble!</span>"
			health =-10
	..()
