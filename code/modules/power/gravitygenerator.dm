...
/obj/machinery/gravity_generator/main/proc/gravity_off()
	for(var/obj/item/I in world)
		sleep(0)
		I.SpinAnimation(rand(100,300))

/obj/machinery/gravity_generator/main/proc/gravity_on()
	for(var/obj/item/I in the_station_areas) 			//for stop spining
		I.SpinAnimation(0,0)
