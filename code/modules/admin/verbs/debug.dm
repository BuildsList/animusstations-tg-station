...
// DEATH SQUADS
		...
		if("emergency response officer")
			...
			if(alert("Code Red ERT?","Select Response Level","Yes","No")=="Yes")
				...
				alert = 0
			switch(input("Which class?") in list("Commander","Security","Engineer","Medic","Chaplain"))
				if("Commander")
				...
				if("Chaplain")
					equip_emergencyresponsesquad(M, "cha",alert)
		...
		if("centcom engineering inspector")
			var/obj/item/device/radio/headset/R = new /obj/item/device/radio/headset/headset_cent/commander(M)
			R.set_frequency(CENTCOM_FREQ)
			R.freqlock = 1
			M.equip_to_slot_or_del(R, slot_ears)
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/under/overalls(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/jacket/puffer(M), slot_wear_suit)
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas/welding(M), slot_wear_mask)
			...
			var/obj/item/weapon/storage/backpack/dufflebag/D = new /obj/item/weapon/storage/backpack/dufflebag(M)
			new /obj/item/weapon/gun/energy/disabler(D)
			M.equip_to_slot_or_del(D, slot_back)

			var/obj/item/weapon/card/id/W = new(M)
			W.icon_state = "centcom"
			W.access = get_all_accesses()
			W.access += get_centcom_access("Special Ops Officer")
			W.assignment = "Engineering Inspector"
			W.registered_name = M.real_name
			W.update_label()
			M.equip_to_slot_or_del(W, slot_wear_id)
...
/proc/equip_emergencyresponsesquad(var/mob/living/carbon/human/M, var/ertrole, var/alert)
	...
	switch(ertrole)
		...
		if("cha")
			W = new /obj/item/weapon/card/id/ert/Chaplain(M)
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/centcom_officer(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/combat/swat(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/combat(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/space/hardsuit/ert/cha(M), slot_wear_suit)
			M.equip_to_slot_or_del(W, slot_wear_id)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/cultpack(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/hud/health(M), slot_glasses)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/box/engineer(M), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/weapon/nullrod(M), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/weapon/reagent_containers/food/drinks/bottle/holywater(M), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/fancy/candle_box(M), slot_r_hand)

			R.keyslot = new /obj/item/device/encryptionkey/heads/cmo

			if(alert)
				M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas/sechailer/swat(M), slot_in_backpack)
				M.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/automatic/ar(M), slot_in_backpack)
				M.equip_to_slot_or_del(new /obj/item/weapon/reagent_containers/hypospray/combat/nanites(M), slot_in_backpack)
				M.equip_to_slot_or_del(new /obj/item/weapon/melee/chainsword/chaplain(M), slot_belt)
			else
				M.equip_to_slot_or_del(new /obj/item/weapon/storage/belt/medical(M), slot_belt)
				M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas/sechailer(M), slot_in_backpack)
				M.equip_to_slot_or_del(new /obj/item/weapon/gun/energy/gun(M), slot_in_backpack)
