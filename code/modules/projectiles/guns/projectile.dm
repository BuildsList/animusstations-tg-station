...
//		return 1
	...
	if(eject_casing)
		...
		playsound(loc, pick('sound/weapons/effects/ShellCasing1.ogg', 'sound/weapons/effects/ShellCasing2.ogg', 'sound/weapons/effects/ShellCasing3.ogg'), 15, 1, 2)
...
/obj/item/weapon/gun/projectile/attack_self(mob/living/user as mob)
	...
	if(magazine)
		...
		playsound(loc, pick('sound/weapons/effects/ShellCasing1.ogg', 'sound/weapons/effects/ShellCasing2.ogg', 'sound/weapons/effects/ShellCasing3.ogg'), 80, 1, 2)
	else
