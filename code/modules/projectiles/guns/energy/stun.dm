...
/obj/item/weapon/gun/energy/comissartaser
	name = "old-fashioned taser gun"
	desc = "Luxury taser gun, handmade by NanoTrasen Military Inc."
	icon_state = "com_energystun"
	ammo_type = list(/obj/item/ammo_casing/energy/electrode)
	origin_tech = null
	pin = null
