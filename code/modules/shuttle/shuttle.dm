...
/obj/machinery/computer/shuttle/survey
	name = "Survey Shuttle Console"
	desc = "Used to call and send the Survey shuttle."
	shuttleId = "survey"
	possible_destinations = "survey_away;survey_home"