...
/obj/item/clothing/suit/space/hardsuit/ert/med
	...
	//ERT Ñhapelan   // lol
/obj/item/clothing/head/helmet/space/hardsuit/ert/cha
	desc = "Standard issue medical helmet for the ERT."
	icon_state = "hardsuit0-ert_capelan"
	item_state = "hardsuit0-ert_capelan"
	item_color = "ert_capelan"

/obj/item/clothing/suit/space/hardsuit/ert/cha
	desc = "Standard issue medical suit for the ERT."
	icon_state = "ert_capelan"
	item_state = "ert_capelan"
	helmettype = /obj/item/clothing/head/helmet/space/hardsuit/ert/cha
	armor = list(melee = 65, bullet = 80, laser = 50, energy = 50, bomb = 90, bio = 100, rad = 100)
