...
/obj/item/weapon/reagent_containers/food/drinks/shaker/verb/empty()    // Wow
	...
	if(usr.stat || !usr.canmove || usr.restrained())
		return
	if (alert(usr, "Are you sure you want to empty that?", "Empty [src.name]:", "Yes", "No") != "Yes")
		return
	if(isturf(usr.loc) && src.loc == usr)
		usr << "<span class='notice'>You empty \the [src.name] onto the floor.</span>"
