...
/datum/configuration
	...
	var/ghosts_need_to_fucking_singulo = 20
	...
	for(var/t in Lines)
		...
		if(type == "config")
			switch(name)
				...
				if("ghosts_need_to_fucking_singulo")
					config.ghosts_need_to_fucking_singulo = text2num(value)
				if("alert_red_upto")
