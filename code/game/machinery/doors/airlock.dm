...
/obj/machinery/door/airlock/attack_hand(mob/user as mob)
	...
	if(istype(user.get_active_hand(), /obj/item/device/hacktool/))
		return src.attack_hack(user, user.get_active_hand())
...
/obj/machinery/door/airlock/Topic(href, href_list, var/nowindow = 0)
	...
	if((istype(usr, /mob/living/silicon) && src.canAIControl()) || (istype(usr.get_active_hand(), /obj/item/device/hacktool/) && (src.canSynControl())))
		//AI
