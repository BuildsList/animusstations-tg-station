...
/datum/file/program/secure_data/proc/canUseSecurityRecordsConsole(mob/user, message1 = 0, record1, record2)
	if(user)
		if(authenticated)
...
/datum/file/program/secure_data
	...
	<th>Criminal Status</th>
					...
					if(3.0)
						...
						if(istype(active1, /datum/data/record) && data_core.general.Find(active1))
							...
							if(istype(active1.fields["photo_side"], /obj/item/weapon/photo))
								...
								usr << browse_rsc(P2.img, "photo_side")
		...
		//usr << browse(text("<HEAD><TITLE>Security Records</TITLE></HEAD><TT>[]</TT>", dat), "window=secure_rec;size=600x400")
		//onclose(usr, "secure_rec")
		var/datum/browser/popup = new(usr, "secure_rec", "Security Records Console", 600, 400)
	...
	//RECORD FUNCTIONS
				...
				if("Print Record")
					if(!( printing ))
						...
						playsound(computer.loc, 'sound/items/poster_being_created.ogg', 100, 1)
						sleep(30)
