...
/obj/machinery/lapvend/proc/scan_card()
	return vend_7()


// Transfers money and vends the laptop.
/obj/machinery/lapvend/proc/vend_7()
...
/obj/machinery/lapvend/proc/reimburse()
	return transfer_and_reimburse()

/obj/machinery/lapvend/proc/transfer_and_reimburse()
	del(relap)
	vendmode = 0
	cardreader = 0
	floppy = 0
