...
/obj/machinery/vending/attackby(obj/item/weapon/W, mob/user, params)
	...
	else if(istype(W, /obj/item/device/pda) && panel_open)
		user << "<span class='notice'>You start to reboot the [src.name] interface.</span>"
		var/obj/item/device/pda/P = W
		if(!P.in_use)
			P.in_use = 1
			if(do_after(user, 3000, target = src) )
				src.emag_act(user)
				P.in_use = 0
			else
				P.in_use = 0
...
/obj/machinery/vending/clown
	name = "\improper Honk Inc"
	desc = "A vending machine which dispenses clown things."
	product_ads = "Have a honk!;Honk up!;It's honk for you!;Would you like a hot honk?;I'd kill for some honk!;The best honk in the galaxy.;Only the finest brew for honk.;Mmmm. Nothing like a honk.;I like honk, don't you?;Clown helps you honk!;Try some honk.;We hope you like the best!;Try our new honk!;Admin conspiracies"
	icon_state = "clown"
	icon_vend = "clown-vend"
	vend_delay = 34
	products = list(/obj/item/weapon/bikehorn = 5,/obj/item/clothing/mask/gas/clown_hat = 5,/obj/item/weapon/soap/deluxe = 3)
	contraband = list(/obj/item/weapon/coin/clown = 10)
	//refill_canister = /obj/item/weapon/vending_refill/coffee

/obj/machinery/vending/chapel
	name = "\improper Chapel Corp"
	desc = "A vending machine which dispenses chapel things."
	product_ads = "I like God, don't you?;Gos helps you live!;Try some God.;We hope you like the best!;Try our new God!;Admin conspiracies"
	icon_state = "chaplain"
	icon_vend = "chaplain-vend"
	vend_delay = 34
	products = list(/obj/item/candle = 15,/obj/item/weapon/lighter/zippo = 3,/obj/item/weapon/reagent_containers/food/drinks/bottle/wine = 3)
	contraband = list(/obj/item/weapon/reagent_containers/food/drinks/bottle/whiskey = 10)
	//refill_canister = /obj/item/weapon/vending_refill/coffee
