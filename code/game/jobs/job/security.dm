...
/datum/job/comissar
	title = "Comissar"
	flag = COMISSAR
	department_head = list("Head of Security","Head of Personnel","Captain")
	department_flag = ENGSEC
	faction = "Station"
	total_positions = 2
	spawn_positions = 2
	...
	default_pda = /obj/item/device/pda/comissar
	default_headset = /obj/item/device/radio/headset/headset_sec/alt
	default_backpack = /obj/item/weapon/storage/backpack/security
	default_satchel = /obj/item/weapon/storage/backpack/satchel_sec

	access = list(access_security, access_sec_doors, access_brig, access_court, access_weapons,
			            access_forensics_lockers, access_medical, access_engine, access_ai_upload, access_eva, access_heads,
			            access_all_personal_lockers, access_maint_tunnels, access_construction, access_morgue,
			            access_cargo, access_cargo_bot, access_mailsorting, access_qm, access_hydroponics, access_lawyer,
			            access_library, access_research, access_mining, access_heads_vault, access_mining_station,
			            access_keycard_auth, access_gateway, access_mineral_storeroom)
...
/datum/job/comissar/equip_items(var/mob/living/carbon/human/H)
	H.equip_to_slot_or_del(new /obj/item/clothing/under/rank/comissar(H), slot_w_uniform)
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/jackboots(H), slot_shoes)
	H.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/comissar(H), slot_wear_suit)
	H.equip_to_slot_or_del(new /obj/item/clothing/head/comissar(H), slot_head)
	H.equip_to_slot_or_del(new /obj/item/clothing/gloves/color/black(H), slot_gloves)
	H.equip_to_slot_or_del(new /obj/item/clothing/glasses/hud/security/sunglasses(H), slot_glasses)
	H.equip_to_slot_or_del(new /obj/item/weapon/melee/classic_baton/telescopic(H), slot_l_store)

	var/obj/item/weapon/gun/energy/comissartaser/rev = new(H)
	rev.pin = new /obj/item/device/firing_pin/implant/loyalty
	if(H.backbag == 1)
		H.equip_to_slot_or_del(rev, slot_l_hand)
		H.equip_to_slot_or_del(new /obj/item/key/security(H), slot_r_hand)
	else
		H.equip_to_slot_or_del(rev, slot_in_backpack)
		H.equip_to_slot_or_del(new /obj/item/key/security(H), slot_in_backpack)
...
/datum/job/officer/equip_items(var/mob/living/carbon/human/H)
	...
	H.equip_to_slot_or_del(new /obj/item/clothing/shoes/jackboots(H), slot_shoes)
	H.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/vest/secnew/officer(H), slot_wear_suit)
