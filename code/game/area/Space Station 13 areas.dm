...
/area/centcom/quarters
	name = "\improper Centcom Quarters"

/area/centcom/dinner
	name = "\improper Centcom Dinner"
...
/area/syndicate_mothership
	...
	requires_power = 0
	has_gravity = 1
	ambientsounds = list('sound/ambience/ambicreek1.ogg', 'sound/ambience/ambicreek2.ogg')
...
/area/security/comissar
	name = "\improper Comissar's Office"
	icon_state = "security"
