...
/datum/uplink_item/stealthy_tools/hacktool
	name = "Hacktool"
	item = /obj/item/device/hacktool
	desc = "You can hack airlock with it, and gain complete control without having to deal with wires."
	cost = 8
