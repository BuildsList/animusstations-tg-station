...
/obj/machinery/atmospherics/unary/engine
	...
	proc									// debug procs
		get_all()
			var/pressurized_coef = air_contents.return_pressure()/effective_pressure
			var/dat = "trust = [round(thrust_limit * nominal_thrust * pressurized_coef)] "
			dat+= "thrust_limit = [thrust_limit] nominal_thrust = [nominal_thrust] "
			dat+= "pressurized_coef = [pressurized_coef]"
			dat+= "air_contents.return_pressure() = [air_contents.return_pressure()] / effective_pressure = [effective_pressure]"
			return dat
...
/obj/machinery/atmospherics/unary/engine/initialize()
	..()
	controller = new /datum/ship_engine/thermal(src)
