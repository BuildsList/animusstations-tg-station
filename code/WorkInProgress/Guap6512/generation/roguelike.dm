			...
			for(var/i = 0, i < iters, i++)
				...
				if(Z)
					if(!locate(/turf/simulated/floor/plating) in Z)
						poss += list(turfs)
			var/list/nodes = list()
			//Creates a list of turfs to place nodes on, so that the hallway can complete it's crea3ion before other
...
datum/minesheep/generator
	var/list/room = list('W','W','A','W','A','W','W','W','W','W','W','W','N',
					     'W','F','F','F','F','F','F','F','F','F','F','F','N',
					     'W','F','F',"O",'T','F','F','F','F','F','F','F','F','N',
					     'W','F','F','F','F','F','F','F','F','F','F','F','N',
					     'W','F','F','F','F','F','F','F','F','F','F','F','N',
					     'W','F','F','F','F','F','F','F','F','F','F','F','N',
					     'W','F','F','F','F','F','F','F','F','F','F','F','N',
	...
	proc
		generate_room(Start_X, Start_Y)
			var/
				room_y = Start_Y
				room_x = Start_X
			if(room.len)
				for(i = 0, i<room.len,i++)
					var/key = room[i]
					if(key == 'W')
					var/turf/simulated/wall = new(room_x,room_y)
					room_x++

					else if(key == 'F')
					var/turf/simulated/floor/plating = new(room_x, room_y)
					room_x++

					else if(key == 'T')
					var/obj/structure/table/wood = new(room_x, room_y)
					room_x++
